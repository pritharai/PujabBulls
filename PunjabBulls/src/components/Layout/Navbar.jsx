...
//         <Link
//           to="/contact"
//           className="flex min-w-21 items-center justify-center rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold shadow-md hover:bg-primary/90 transition-all"
//         >
//           Contact Us
//         </Link>
//       </div>
